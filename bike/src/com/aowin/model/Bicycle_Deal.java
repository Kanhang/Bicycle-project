...
Integer pile_id;
Integer user_id;
public Bicycle_Deal(Integer deal_id, String create_time, String deal_name,
		String deal_type, Integer record_id, Integer card_id, String is_fee,
		Double chg_money, Integer fee_type, Integer bicycle_id,
		Integer pile_id, Integer user_id) {
	super();
...
public String toString() {
	return "Bicycle_Deal [deal_id=" + deal_id + ", create_time=" + create_time
			+ ", deal_name=" + deal_name + ", deal_type=" + deal_type
			+ ", record_id=" + record_id + ", card_id=" + card_id + ", is_fee="
			+ is_fee + ", chg_money=" + chg_money + ", fee_type=" + fee_type
			+ ", bicycle_id=" + bicycle_id + ", pile_id=" + pile_id
			+ ", user_id=" + user_id + "]";
}
